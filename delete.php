							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="fruit" style="color: black;">Summer</option>
										<option value="vegetable" style="color: black;">Winter</option>
										<option value="grain" style="color: black;">Monsoon</option> 
										<!-- Grains -->
									</select>
							  	</div>
							</div>
				...
				<?php
					...
					<?php
						...
						while($row = $result->fetch_array()):
							$picDestination = "./ImagesAg/".$row['pimage'];
					?>
							<div class="col-md-4">
							<section>
							<strong><h2 class="title" style="color:black; "><?php echo $row['product'].'';?></h2></strong>
							<a href="deleteitem.php?pid=<?php echo $row['pid'] ;?>" > <img class="image fit" src="<?php echo $picDestination;?>" height="220px;"  /></a>
