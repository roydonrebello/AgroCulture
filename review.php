						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Market Price : <?= $row['price'].' /-'; ?></p>
								</div>
							</div><br />
							<div class="row">
								<h1 style="color:white; padding-left:50%;font-family:bold;">Description</h1>
								<div class="col-12 col-sm-12" style="font: 30px Times new roman; color:black;">
									<?= base64_decode($row['pinfo']); ?>
								</div>
							</div>
						</div>
