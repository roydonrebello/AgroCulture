	...
	<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><button class="button fit login-button" onclick="document.getElementById('id01').style.display='block'" style="width:auto">LOGIN</button></li>

						<!-- <li><a href="market.php"><span class="glyphicon glyphicon-grain">Agro-Cycle </a></li>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>AgroCulture</h2>
				<p style='font-size: 25px;'>Discover the keys to thriving agriculture Explore AgroCulture to find the perfect crops for every season and cultivate your land with confidence.</p>
				<br><br>
...
<!-- </center></div> -->
<!--<div class="center">
    <button class="button fit" onclick="document.getElementById('id02').style.display='block'">REGISTER</button>
</div>-->
<!--<div class="button-container">
    <button class="custom-button" onclick="document.getElementById('id02').style.display='block'">REGISTER</button>
</div>-->
...
<section id="one" class="wrapper style1 align-center" style="height: 600px">
				<div class="container">
					...
					<!-- <div class="row 200%"> -->
						...
						<!-- <section class="4u 12u$(small)" style="padding-left:50%;text-align:center"> -->
							<a href="productMenu.php?n=1" name="catSearch"><img src="search.png"></a>
							<h3 style="color:white;">Search according to your needs</h3>
		...
		<center>
			...
			<br />
			<p style="font-size:20px;color:white">Seasonal Crop selection !!!</p>
			<br />
</center>
